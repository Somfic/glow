...
const C = f(0.1031);
const K = f(33.33);
const fr = (v: number) => f(v - Math.floor(v));
...
export function bakeNoiseLut(): Uint8Array {
...
export function createNoiseTexture(gl: WebGL2RenderingContext): WebGLTexture | null {
