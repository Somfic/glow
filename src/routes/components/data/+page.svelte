<script lang="ts">
	...
	import type { DataItem, DataGroup } from '$lib/data/types.js';

	const userProperties: DataItem[] = [
	...
	const serverProperties: DataItem[] = [
...
<svelte:head><title>Data | Glow UI</title></svelte:head>
...
/>`}
	...
	<Group label="Data Props" id="props">
		<Table
			...
			data={[
				{ prop: 'properties', type: 'DataItem[]', default: '-', description: 'Flat list of property items' },
				{ prop: 'groups', type: 'DataGroup[]', default: '-', description: 'Grouped property sections' },
