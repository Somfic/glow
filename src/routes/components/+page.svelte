	...
	const components = [
		...
		},
		{
			...
			items: [
				...
				{ name: 'Stat', href: '/components/stat', description: 'A single figure and what it means — unit, delta, and a trend line' },
				...
				{ name: 'Animated Value', href: '/components/animated-value', description: 'A value animated when it changes — numbers count, strings crossfade' },
				{ name: 'Typewriter', href: '/components/typewriter', description: 'Text that reveals progressively, the way streamed output arrives' },
