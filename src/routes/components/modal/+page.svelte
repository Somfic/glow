	...
	<Group label="Props" id="props">
		<Table
			...
			data={[
				...
				{ prop: 'size', type: "'small' | 'medium' | 'large'", default: "'medium'", description: 'Modal width' },
				{ prop: 'actions', type: 'ModalAction[]', default: '[]', description: 'Footer action buttons' },
				{ prop: 'closeOnBackdropClick', type: 'boolean', default: 'true', description: 'Allow closing by clicking backdrop' }
			]}
		/>
	</Group>
