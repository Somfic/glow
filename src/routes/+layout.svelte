		...
		groups: [
			...
			},
			{
				...
				items: [
					...
					{ label: 'Stat', href: '/components/stat', icon: 'Gauge' },
					{ label: 'Charts', href: '/components/charts', icon: 'ChartLine' },
					{ label: 'Empty State', href: '/components/empty-state', icon: 'Inbox' },
					{ label: 'Animated Value', href: '/components/animated-value', icon: 'Sparkles' },
					{ label: 'Typewriter', href: '/components/typewriter', icon: 'TypeOutline' },
