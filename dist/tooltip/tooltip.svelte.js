...
export function tooltip(node, params) {
    ...
    let isShowing = false;
    const options = typeof params === 'string' ? { content: params, useCursor: true } : { useCursor: true, ...params };
    ...
    function getPosition(triggerRect, pos) {
        const margin = 8;
        let x = 0;
        let y = 0;
    ...
    return {
        update(newParams) {
            ...
            hide();
            const newOptions = typeof newParams === 'string' ? { content: newParams } : newParams;
